function result = dxx(im,edges)
% DXX: 2nd X-derivative of an image, using upConv, and 5-tap derivative
...
tmp = upConv(im,sdd,[1,1],[0,0],edges);
result = upConv(tmp,s',[1,1],[0,0],edges);
