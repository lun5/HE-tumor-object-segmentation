...
%
% Construct a complex steerable pyramid on matrix IM, in the Fourier domain.
% NOTE: this function is significantly faster for images whose
% dimensions are powers of 2.  This is similar to buildSpyr, except
% that:
%
