...
%         imwrite(uint8(segmented_image),fullfile(RESULTS_DIR,'segmented_images01',[im_name '_segmentedImage.tif']),'Resolution',300);         
%         end
...
for i=1:length(img_list)
        ...
        if ~exist(fullfile(RESULTS_DIR,'montageImageSegment01',[im_name '_montage.tif']),'file')
