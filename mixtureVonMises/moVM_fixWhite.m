%% function [ mu_hat_polar, mu_hat_cart, kappa_hat,posterior_probs] = moVM_fixWhite(X_cart,k,opts)
% 
% INPUTS ONLY IN 2D!!!!!
...
function [ mu_hat_polar,mu_hat_cart, kappa_hat,posterior_probs, prior_probs] = moVM_fixWhite(X_cart,k,opts,init_params)
    ...
    if isempty(init_params)
        ...
        pink_peak = peakfinder(values(1:pink_interval));
        mu_hat_polar(2) = bin_centers(pink_peak(1)); %stroma pink
