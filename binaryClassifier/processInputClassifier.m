...
parfor ind = 1: numImages
    ...
    [f_maps] = getFeatures(RGB_A,scale,{which_features},opts);
    feat_A = reshape(f_maps{1},[numSamples numFeats]);
    [f_maps] = getFeatures(RGB_B,scale,{which_features},opts);
...
fprintf('Calculate external statistics...\n');tic;
